...
class ChangeReportDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    ...
    signature_confirmation: Field::String.with_options(searchable: false),
    consent_to_sms: Field::String.with_options(searchable: false),
    feedback_rating: Field::Number,
