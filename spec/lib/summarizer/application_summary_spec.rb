...
RSpec.describe Summarizer::ApplicationSummary do
  describe "#run" do
    it "returns a summary of daily change reports for date and timezone" do
      ...
      create_list(:change_report, 2, :signed, created_at: date)

      create(:change_report, :signed, created_at: date - 1.day)
      create(:change_report, :signed, created_at: date + 21.hours)
      create(:change_report, :signed, created_at: date + 1.day)
    ...
    it "only includes signed change reports" do
      ...
      create(:change_report, created_at: date)
      create(:change_report, :signed, created_at: date)
