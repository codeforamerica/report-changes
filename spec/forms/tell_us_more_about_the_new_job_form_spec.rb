...
RSpec.describe TellUsMoreAboutTheNewJobForm do
  ...
  describe "#save" do
    ...
    it "persists the values to the correct models" do
      ...
      expect(report.current_change.first_day.year).to eq 2000
      expect(report.current_change.first_day.month).to eq 1
      expect(report.current_change.first_day.day).to eq 15
      expect(report.current_change.paid_yet_yes?).to be_truthy
    end
  end
