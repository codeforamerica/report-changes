 ...
 RSpec.describe DoYouHaveChangeInHoursDocumentsForm do
   describe "validations" do
     context "when has_change_in_hours_documents is provided" do
       it "is valid" do
         form = DoYouHaveChangeInHoursDocumentsForm.new(nil, has_change_in_hours_documents: "yes")
     ...
     context "when has_change_in_hours_documents is not provided" do
       it "is invalid" do
         form = DoYouHaveChangeInHoursDocumentsForm.new(nil, has_change_in_hours_documents: nil)
   ...
   describe "#save" do
     ...
     it "persists the values to the correct models" do
       form = DoYouHaveChangeInHoursDocumentsForm.new(report, valid_params)
       form.valid?
       form.save
   ...
   describe ".from_report" do
     it "assigns values from change report navigator" do
       ...
       form = DoYouHaveChangeInHoursDocumentsForm.from_report(report)
