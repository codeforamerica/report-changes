...
RSpec.describe OverlappingZipCodeForm do
  describe "validations" do
    context "when county is provided" do
      it "is valid" do
        form = OverlappingZipCodeForm.new(
          nil,
          county: "Arapahoe",
        )
  ...
  describe "#save" do
    ...
    it "persists the values to the correct models" do
      form = OverlappingZipCodeForm.new(report, valid_params)
      form.valid?
      form.save
  ...
  describe ".from_report" do
    it "assigns values from change report" do
      ...
      form = OverlappingZipCodeForm.from_report(report)
