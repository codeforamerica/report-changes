...
RSpec.describe NewJobSignpostController do
  ...
  describe "#show?" do
    context "when a single change type is being reported" do
      it "returns false" do
        ...
        show_form = NewJobSignpostController.show?(report)
        expect(show_form).to eq(false)
      end
    end

    context "when multiple change types are being reported" do
      context "and change types include new_job" do
        it "returns true" do
      ...
      context "and change types do not include new_job" do
        it "returns false" do
          report = create(:report)
