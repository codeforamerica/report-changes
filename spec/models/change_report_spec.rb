...
RSpec.describe ChangeReport, type: :model do
  describe ".signed" do
    let!(:signed_change_report) { create :change_report, signature_confirmation: "yes", signature: "Quincy Jones" }
    let!(:second_signed_change_report) { create :change_report, signature_confirmation: "yes", signature: "Frank Sinatra" }
    let!(:unsigned_change_report) { create :change_report, signature_confirmation: "unfilled", signature: "Count Basie" }
