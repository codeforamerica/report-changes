  ...
  describe "#must_have_not_yet_supported_county" do
    context "with supported county" do
      it "returns true" do
        ...
        expect(SkipRules.must_have_not_yet_supported_county(change_report)).to eq(true)
      end
    end
    ...
    context "with not supported county" do
      it "returns false" do
        ...
        expect(SkipRules.must_have_not_yet_supported_county(change_report)).to be_falsey
      end
    end
  end
end
